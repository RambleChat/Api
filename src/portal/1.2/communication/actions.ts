...
import { CancellationType, ChatCommunicationInfo, ChatUpdateType } from "./interfaces";

/**
 * New chat payload
 */
export interface CreateChatRealtimePayload extends ChatCommunicationInfo {}
...
export interface DirectChatReplyRequestPayload {
    /**
     * Chat uuid
     */
    uuid: string;
...
export interface DirectChatReplyResponsePayload { }

/**
 * Direct chat replying without pre-authentication
 */
export type DirectChatReplyAction = ActionDescriptor<typeof DIRECT_REPLY_CHAT, DirectChatReplyRequestPayload, DirectChatReplyResponsePayload>;
