...
import {
    HISTORY_GET_CHAT,
    HISTORY_GET_CHATS,
    REALTIME_ARCHIVED_STATUS_CHANGED,
    REALTIME_WAS_CLAIMED,
    REALTIME_WAS_NOTIFIED,
    REALTIME_WAS_UNNOTIFIED,
    SET_ARCHIVED_STATUS,
 ...
 */
export interface GetChatFullResponsePayload extends ChatCommunicationInfo {}
