...
export type RegisterForPushNotificationsAction =
    ActionDescriptor<typeof REGISTER_FOR_PUSH_NOTIFICATIONS, RegisterForPushNotificationsRequestPayload, RegisterForPushNotificationsResponsePayload>;
