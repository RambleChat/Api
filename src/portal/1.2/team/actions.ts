...
import {
    ...
    DELETE_TEAM_CODE,
    LEAVE_TEAM,
    REALTIME_BLACKLIST_CHANGED,
    REALTIME_CODE_ADDED,
    REALTIME_CODE_DELETED,
...
export interface UpdateBlacklistRequestPayload {
    teamId: number;
    blacklist: Array<{ type: "email"; value: string }>;
}

export interface UpdateBlacklistResponsePayload { }

export type UpdateBlacklistAction = ActionDescriptor<typeof UPDATE_BLACKLIST, UpdateBlacklistRequestPayload, UpdateBlacklistResponsePayload>;
export type UpdateBlacklistServerAction = ServerRealtimeAction<typeof REALTIME_BLACKLIST_CHANGED, UpdateBlacklistRequestPayload>;
