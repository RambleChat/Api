...
/**
 * Chat presence action: agent joined/leaved
 */
export const REALTIME_CHAT_AGENT_PRESENCE = "visitor/CHAT_PRESENCE";

/****************** Deprecated in 1.2 ****************************/

/**
 * Chat has been canceled by timeout
 * @deprecated REALTIME_CHAT_ENDED has reason information
 */
export const REALTIME_CHAT_CANCELED = "visitor/CHAT_CANCELED";

/**
 * Chat was answered by agent
 * @deprecated Use presence agent actions
 */
