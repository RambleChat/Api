...
export type VisitorChatAgentPresenceAction = ServerRealtimeAction<typeof REALTIME_CHAT_AGENT_PRESENCE, {
    /**
     * Chat uuid
     */
    id: string;
    ...
    type: "enter" | "leave";
    /**
     * Agent information who joined/leave
     */
    agent: {
        id: number;
        firstName: string;
...
export type ChatServerActions =
    ...
    VisitorChatAgentPresenceAction;
